...
本笔记本介绍了如何从 [polars](https://pola-rs.github.io/polars-book/user-guide/) 数据框加载数据。
...
```python
<!--IMPORTS:[{"imported": "PolarsDataFrameLoader", "source": "langchain_community.document_loaders", "docs": "https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.polars_dataframe.PolarsDataFrameLoader.html", "title": "Polars DataFrame"}]-->
