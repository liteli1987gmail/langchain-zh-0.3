...
本笔记本介绍了如何从 [xorbits.pandas](https://doc.xorbits.io/en/latest/reference/pandas/frame.html) 数据框加载数据。
...
```python
<!--IMPORTS:[{"imported": "XorbitsLoader", "source": "langchain_community.document_loaders", "docs": "https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.xorbits.XorbitsLoader.html", "title": "Xorbits Pandas DataFrame"}]-->
