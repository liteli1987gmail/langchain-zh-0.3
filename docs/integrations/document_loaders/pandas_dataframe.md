...
本笔记本介绍了如何从 [pandas](https://pandas.pydata.org/pandas-docs/stable/user_guide/index) 数据框加载数据。
...
```python
<!--IMPORTS:[{"imported": "DataFrameLoader", "source": "langchain_community.document_loaders", "docs": "https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html", "title": "Pandas DataFrame"}]-->
