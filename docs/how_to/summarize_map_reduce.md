---
custom_edit_url: https://github.com/langchain-ai/langchain/edit/master/docs/docs/how_to/summarize_map_reduce.ipynb
sidebar_position: 3
...
- LangGraph 的 [检查点](https://langchain-ai.github.io/langgraph/how-tos/persistence/) 支持错误恢复，扩展人机协作工作流，并更容易融入对话应用程序。
...
首先我们加载文档。我们将使用 [WebBaseLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.web_base.WebBaseLoader.html) 来加载一篇博客文章，并将文档拆分为更小的子文档。
...
### 映射步骤
首先定义与映射步骤相关的提示词，并通过 [链](/docs/how_to/sequence/) 将其与大型语言模型关联：
...
查看 [LangGraph 文档](https://langchain-ai.github.io/langgraph/) 以获取有关使用 LangGraph 构建的详细信息，包括关于 LangGraph 中 map-reduce 细节的 [本指南](https://langchain-ai.github.io/langgraph/how-tos/map-reduce/)。

请参阅摘要 [操作指南](/docs/how_to/#summarization) 以获取其他摘要策略，包括针对较大文本量设计的策略。
